...
cd $HOME
echo -e "\x1B[01;92m Creating the ./ecstatic-nobel/ directory \x1B[0m"
mkdir ./ecstatic-nobel/
echo -e "\x1B[01;92m Changing directory to ./ecstatic-nobel/ \x1B[0m"
cd ./ecstatic-nobel/

echo -e "\x1B[01;92m Cloning the ansible-N-vagrant project \x1B[0m"
git clone https://github.com/ecstatic-nobel/ansible-N-vagrant.git
